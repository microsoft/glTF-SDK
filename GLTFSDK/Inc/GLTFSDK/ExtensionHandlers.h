...
namespace Microsoft
{
    namespace glTF
    {
        ...
        class ExtensionSerializer : public ExtensionHandlers<std::string, Extension, Document>
        {
        public:
            ExtensionPair Serialize(const Extension& extension, const glTFProperty& property, const Document& document) const;
        };

        class ExtensionDeserializer : public ExtensionHandlers<std::unique_ptr<Extension>, std::string>
        {
        public:
